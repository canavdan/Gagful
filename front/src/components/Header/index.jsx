...
const Header = () => (
  <header className="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
    ...
    <ul className="navbar-nav bd-navbar-nav flex-row"> 
      <li className="nav-item">
        <a className="nav-link" href="/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Bootstrap');">GAGFUL</a>
      </li>
    </ul>
  </div> 
  ...
  <a className="btn btn-bd-download d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="/docs/4.3/getting-started/download/">Download</a>
  </header>
)
